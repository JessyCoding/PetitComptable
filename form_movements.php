...
<html>
    ...
    <section id="infoSection" class="flexTag">
            ...
            <div class="flexTag">
                <table>
                    <tr>
                        ...
                        <th></th>
                        <th><span class="spanWhiteShadow">Category</span></th>
                        <th></th>
                        <th><span class="spanWhiteShadow">Amount</span></th>
                        <th><span class="spanWhiteShadow">Method</span></th>
                        <th></th>
                        <th></th>
                    </tr>
        ...
        <div class="logo"><img src="logo.png"/><p><span class="spanWhiteShadow">Voici la liste des opérations de ce compte</span></p><div class="form formDark"><p>
                <?php
                    $ba = get_bankaccount();
